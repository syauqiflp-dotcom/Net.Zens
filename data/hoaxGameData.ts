...
export const hoaxGameData: GameTask[] = [
  ...
  // Task 5: Swipe (Facebook/Social Media View)
  {
    ...
    claim: 'TERBONGKAR! Kopi herbal ini terbukti secara klinis bisa menyembuhkan diabetes dalam 24 Jam!',
  ...
  // Task 9: Drag & Drop - Article View
  {
    ...
    type: 'drag-drop',
    displayType: 'article',
    scenario: 'Bedah Artikel',
    dropZoneLabels: {
      zoneA: { label: 'Hoaks', icon: '💀' },
      zoneB: { label: 'Fakta', icon: '✅' },
    },
    articleContent: {
        headline: "Pajak Ponsel Naik 50% Bulan Depan?",
        author: "Redaksi",
        date: "5 Menit yang lalu",
        imageUrl: "https://images.unsplash.com/photo-1596742578443-7682ef5251cd?w=800&q=70",
        messageParts: [
            ...
            { text: '100% benar, menurut "sumber orang dalam"', isDraggable: true, id: 'dd2' },
            { text: ' dan menyertakan tautan', isDraggable: false },
            { text: ' https://kemenkeu.info/pajak50.', isDraggable: true, id: 'dd3' },
            { text: 'Pesan ini juga diakhiri dengan kalimat provokatif seperti', isDraggable: false },
            { text: ' SEBARKAN segera sebelum info ini ditutup-tutupi oleh media!', isDraggable: true, id: 'dd4' },
            { text: '\n\nNamun, benarkah informasi ini? Sejauh ini, Kominfo belum memberikan tanggapan.', isDraggable: false },
            { text: 'Masyarakat diimbau untuk tidak panik dan selalu melakukan verifikasi.', isDraggable: true, id: 'dd5' },
            { text: 'Jika ragu, Anda bisa menghubungi', isDraggable: false },
            { text: ' Call Center Kemenkeu di 134.', isDraggable: true, id: 'dd6' },
        ]
    },
    items: [
      ...
      { id: 'dd2', text: '100% benar, menurut "sumber orang dalam"', correctDrop: 'zoneA' },
      { id: 'dd3', text: 'https://kemenkeu.info/pajak50', correctDrop: 'zoneA' },
      { id: 'dd4', text: 'SEBARKAN segera sebelum info ini ditutup-tutupi oleh media!', correctDrop: 'zoneA' },
      { id: 'dd5', text: 'Masyarakat diimbau untuk tidak panik dan selalu melakukan verifikasi.', correctDrop: 'zoneB' },
      { id: 'dd6', text: 'Call Center Kemenkeu di 134.', correctDrop: 'zoneB' },
    ]
  }
];